...
for (const file of ['index.html','styles.css','hills.css','tree-v2.css','tree-tabs.css','timeline-tabs.css','gallery.css','archive.css','visitors.css','layout-fixes.css','admin.css','person-management.css','change-history.css','sources.css','research-tools.js','gedcom-import.js','person-management.js','change-history.js','app.js','people.js','tree-v2.js','gallery.js','visitors.js','admin.js','surname-note.js','favicon.svg','family-crest.png','admin-share.png','admin-preview-v2.jpg','family-preview-v2.jpg']) {
