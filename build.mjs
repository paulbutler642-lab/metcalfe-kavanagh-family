...
for (const file of ['index.html','styles.css','hills.css','tree-v2.css','tree-tabs.css','gallery.css','admin.css','app.js','tree-v2.js','gallery.js','admin.js','surname-note.js','favicon.svg','family-shield.svg']) {
