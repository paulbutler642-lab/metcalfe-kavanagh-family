...
export default async function handler(req,res){
  ...
  try{
    ...
    }catch(aiError){console.error('family-historian-ai',aiError);out=fallback(evidence,aiDiagnostic(aiError.status))}}
