...
// The first wide landscape image works best in the shallow landing-page hero.
const ALTADORE_HERO=ALTADORE_IMAGES[0]
...
function installAltadore(){
 ...
 hero.style.backgroundImage=`linear-gradient(rgba(16,48,39,.36),rgba(16,48,39,.60)),url("${ALTADORE_HERO}")`
