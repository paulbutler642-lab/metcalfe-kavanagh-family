...
if(params.get('view')==='profile'){
 const install=async()=>{
  ...
  try {
   ...
   // Re-check after async work in case another observer callback completed first.
   ...
   // Place once, directly below the profile tabs and before automated record notices.
